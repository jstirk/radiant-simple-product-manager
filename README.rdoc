...
they do not recurse down into sub-Categories.
  ...
  <r:product:images:each [limit=""] [order="filename ASC"]>...</r:product:images:each>
    <r:product:image:description />
    <r:product:image:filename />
    <r:product:image:thumbnail_url />
    <r:product:image:url />
    <r:product:image:thumbnail_tag [alt="description"] [width=""] [height=""] />
    <r:product:image:tag [alt="description"] [width=""] [height=""] />
