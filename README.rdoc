...
Within this page will be rendered the "category" snippet. The snippet will be rendered in the context of the Category, loaded by <r:category:find>.

Product pages will be displayed in the "Product" layout by default, but this can be changed by the "simple_product_manager.product_layout" setting.

Within this page will be rendered the "product" snippet. The snippet will be rendered in the context of the Product, loaded by <r:product:find>.
